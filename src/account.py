...
class Account():
    def __init__(self, name='', surname='', birthday='', email='', interests='', wishlist='', friendlist='', ID = None):
        if ID != None:
    ...
    def create_account(self):
        accountMan = AccountInfo()
        acc = accountMan.create_account(self.name, self.surname, self.birthday, self.email, self.interests, self.wishlist, self.friendlist)
        return acc
    ...
    def update_account(self, name='', surname='', birthday='', email='', interests='', wishlist='', friendlist=''):
            self.name = name
            self.surname = surname
            self.birthday = birthday
            self.email = email
            ...
            self.friendlist = friendlist
            accountMan = AccountInfo()
            accountMan.update_account(self.ID, name, surname, birthday, email, interests, wishlist, friendlist)
